                ...
                <tbody>
                    ...
                    foreach ($buku as $b) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('buku/ubahBuku/') . $b['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i>
                                    Ubah</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-tittle" id="bukuBaruModalLabel">Tambah Buku</h5>
            ...
            <form action="<?= base_url('buku') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-plus-cricle"></i> Tambah</button>
                </div>
            </form>
        </div>
    </div>
