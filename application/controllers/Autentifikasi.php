...
class Autentifikasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('password', 'Passowrd', 'required|trim', [
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert_message" role="alert">Password salah!!</div>');
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert_message" role="alert">Email tidak terdaftar</div>');
            redirect('autentifikasi');
        }
    }
